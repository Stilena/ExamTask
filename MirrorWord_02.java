...
public class MirrorWord_02 {
    public static void main(String[] args) {
        ...
        while (matcher.find()){
            ...
            String secondReverseWord=reverseWord(matcher.group(3));
           if (firstWord.equals(secondReverseWord)){
               StringBuilder sb =new StringBuilder(firstWord);
               sb.append(" <=> " + matcher.group(3));
               mirrorWord.add(sb.toString());
           }
        }
        if (count==0){
    ...
    private static String reverseWord(String group) {
